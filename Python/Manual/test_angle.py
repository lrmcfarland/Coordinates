...
class TestAngle(unittest.TestCase):
    ...
    def test_inplace_add_exception_string(self):
    ...
    def test_inplace_add_double(self):
        ...
        a1 = coords.angle(self.rd1)
        a1 += 30.0
        self.assertAlmostEqual(self.rd1 + 30, a1.degrees, self.places)
        return


    def test_angle_add_angle(self):
        """Test angle + angle"""
        a1 = coords.angle(self.rd1)
        a2 = coords.angle(self.rd2)
        a3 = a1 + a2
    ...
    def test_angle_add_string_exception(self):
        """Test angle + string"""
        a1 = coords.angle(self.rd1)
        try:
            a3 = a1 + 'asdf'
    ...
    def test_string_add_angle_exception(self):
        """Test string + angle"""
        a1 = coords.angle(self.rd1)
        try:
            a3 = 'asdf' + a1
    ...
    def test_angle_add_double(self):
        """Test angle + double"""
        a1 = coords.angle(self.rd1)
        a3 = a1 + self.rd2
        self.assertAlmostEqual(self.rd1 + self.rd2, a3.degrees, self.places)
    ...
    def test_double_add_angle(self):
        """Test double + angle"""
        a1 = coords.angle(self.rd1)
        a3 = self.rd2 + a1
        self.assertAlmostEqual(self.rd1 + self.rd2, a3.degrees, self.places)
    ...
    def test_inplace_minus_double(self):
        """Test angle -= double"""
        a1 = coords.angle(self.rd1)
        a1 -= self.rd2
        self.assertAlmostEqual(self.rd1 - self.rd2, a1.degrees, self.places)
    ...
    def test_angle_multiply_double(self):
        """Test angle * double"""
        a1 = coords.angle(self.rd1)
        a3 = a1 * self.rd2
        self.assertAlmostEqual(self.rd1 * self.rd2, a3.degrees, self.places)
    ...
    def test_double_multiply_angle(self):
        """Test double * angle"""
        a1 = coords.angle(self.rd1)
        a3 = self.rd2 * a1
        self.assertAlmostEqual(self.rd1 * self.rd2, a3.degrees, self.places)
    ...
    def test_inplace_divide_double(self):
        """Test angle /= double"""
        a1 = coords.angle(self.rd1)
        a1 /= self.rd2
        self.assertAlmostEqual(self.rd1 / self.rd2, a1.degrees, self.places)
